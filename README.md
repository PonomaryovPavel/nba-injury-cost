...
**Структурные повреждения — отдельный класс.** Разрывы и переломы стоят от 44 до 212
игровых дней. Мягкие ткани и ушибы — от 5 до 11. Между группами разрыв почти в порядок
величины, промежуточных значений практически нет.
...
| Перелом | 220 | 46 | 230 |
| Разрыв связок колена (MCL/PCL) | 45 | 44 | 163 |
...
3. **Разметка по тексту.** Правила проверяются по порядку, первое совпадение выигрывает.
   ...
   иначе тендинит и разрыв попадают в одну категорию.
